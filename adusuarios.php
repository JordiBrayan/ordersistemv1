...
<section id="home">
  ...
  <br>
    <br>     
		<div class="col-md" >
		<h2 style="text-align: center;">¡¡Administra a tus meseros!!</h1>
			<p style="text-align: center;">Aquí podrás administrar a todos tus meseros para poder eliminar y agregar uno nuevo.</p>   
...
<section >
        <div class="container"  class="table-responsive">
            ...
            <div style="text-align: center;">
                <button type="button" class="btn btn-warning"><a class="btn" href="agrusu.html" style="color:black; "><strong>Agregar nuevo mesero</strong></a></button>
            </div>
            </form>
        ...
        <div class="row" style="text-align: center;">
            ...
            <div  style="text-align: center;" >
            	<div class="col" style="text-align: center;">
                    <h4 style="text-align: center;">Administra a tus meseros</h4>
                    <p >Revisa todos los datos de tus meseros para poder llevar un mejor control.</p>
