...
<section id="home">
  ...
  <br>
    <br>     
		<div class="col-md" >
		<h2 style="text-align: center;">¡¡Administra tu menú!!</h1>
			<p style="text-align: center;">Aquí podrás gestionar todos tus productos para poder eliminar y agregar nuevos productos.</p>   
        ...
        <div class="row" style="text-align: center;">
            ...
            <div  style="text-align: center;" >
            	<div class="col" style="text-align: center;">
                    <h4 style="text-align: center;"> Administra tu menú </h4>
