            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="caviar-single-dish wow fadeInUp" data-wow-delay="0.5s">
                        <img src="img/menu-img/iconajust.png" alt="" width="220" height="50">
                        <div class="dish-info">
                            <h6 class="dish-name">Administrar Menu</h6>
                            <a class="dish-price" href="admenu.php"><strong>Entrar</strong></a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-4">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="footer-text">
                        ...
                        <p>Dale una mejor calidad de servicio a tus comensales!!!</p>
                        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    </div>
                </div>
            </div>
